 ...
 *
 */
angular.module('indeuApp').factory('SelectStaticPageModal', function($modal, $q) {
	...
	function($scope, ESPBA, Lookup, Utils, Const, DTOptionsBuilder, DTColumnBuilder) {
		...
		$scope.title = 'Vælg en statisk side fra listen';
      ...
      DTColumnBuilder.newColumn('sub_header').withTitle('Manchet')
		...
		$scope.dtOptions = DTOptionsBuilder
			.fromFnPromise(function() {
				var defer = $q.defer();
				ESPBA.get('static_page', {}).then(function(res) {
